...
class WC_Payment_Token_CC
{
    ...
    public function set_gateway_id($id)
    {
...
class WC_Order
{
    ...
    {
        $this->data['payment_method_title'] = $title;
    }
...
// tests/mocks/WC_Logger_Mock.php
class WC_Logger_Mock
{
    ...
    // WooCommerce sometimes calls alert(), warning(), notice(), critical()
