=== Payload WooCommerce Payment Gateway ===

Contributors: payload
Tags: credit card, payment request, payments
...
Accept WooCommerce payments through Payload.com 
...
* Saved payment methods on classic checkout
* Fixed classic checkout submission when a non-Payload gateway is selected
...
* Fixed payment method description in WooCommerce Blocks integration 
* Added a description when initiating a payload transaction
* Added reference ID metadata to customers and payment methods
* Fixed script loading to ensure loading in the body versus head
